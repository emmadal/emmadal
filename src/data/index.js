...
const data = [
    {
        ...
        description: 'GraphQL Server build with appolo-server that allow us to add, delete, update and querie the data into the database',
    ...
    {
        title: 'PROInvest',
        description: 'PROInvest + is a program developed by LUMEN CORPORATION SAS which aims to connect local investors (employees, civil servants, traders) and local entrepreneurs (SMEs, Startups). This call for projects aims to offer entrepreneurs the possibility of bidding in order to obtain funding for the establishment or development of their projects.',
